            ...
            <div className="container mx-auto max-w-3xl">
                <div className="rounded-3xl bg-linear-to-b from-violet-900/20 to-violet-900/5 border border-violet-500/20 p-12 md:p-16 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        >
                            Fale com nossa equipe e descubra como o Simplifisca NFe pode transformar a gestão do seu negócio com soluções simples, eficientes e simplificadas.
                        </motion.p>
                        <motion.div
                            initial={{ y: 60, opacity: 0 }}
                            whileInView={{ y: 0, opacity: 1 }}
                        ...
                        >
                            <GhostButton className="px-8 py-3 gap-2">
                                Fale conosco! <ArrowRightIcon size={20} />
                            </GhostButton>
                        </motion.div>
                    </div>
                </div>
